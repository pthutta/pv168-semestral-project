...
import cz.muni.fi.pv168.impl.EntityNotFoundException;
import cz.muni.fi.pv168.impl.ServiceFailureException;
...
public class CauldronManagerImpl implements CauldronManager {
    ...
    @Override
    public void createCauldron(Cauldron cauldron) throws ServiceFailureException {
    ...
    @Override
    public Cauldron findCauldronById(Long id) throws ServiceFailureException {
        try (
                Connection connection = dataSource.getConnection();
                PreparedStatement st = connection.prepareStatement(
    ...
    @Override
    public void updateCauldron(Cauldron cauldron) throws ServiceFailureException {
        validate(cauldron);
        if (cauldron.getId() == null) {
    ...
    @Override
    public void deleteCauldron(Cauldron cauldron) throws ServiceFailureException {
        if (cauldron == null) {
            throw new IllegalArgumentException("cauldron is null");
        }
        if (cauldron.getId() == null) {
    ...
    @Override
    public List<Cauldron> findAllCauldrons() throws ServiceFailureException {
        try (
                Connection connection = dataSource.getConnection();
                PreparedStatement st = connection.prepareStatement(
